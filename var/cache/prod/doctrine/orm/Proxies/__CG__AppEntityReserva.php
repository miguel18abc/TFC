 ...
 */
class Reserva extends \App\Entity\Reserva implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Reserva $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setUsername(string $Username): \App\Entity\Reserva
    {
