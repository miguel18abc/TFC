 ...
 */
class getFamiliaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FamiliaRepository' shared autowired service.
     *
     * @return \App\Repository\FamiliaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FamiliaRepository.php';

        return $container->privates['App\\Repository\\FamiliaRepository'] = new \App\Repository\FamiliaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
