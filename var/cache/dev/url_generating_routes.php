...
return [
    ...
    'cita_consulta_tutoria' => [['username'], ['_controller' => 'App\\Controller\\FamiliaController::consultasTutoria'], [], [['variable', '/', '[^/]++', 'username', true], ['text', '/consulta/tutoria']], [], [], []],
    'orientacion' => [[], ['_controller' => 'App\\Controller\\FamiliaController::indexOrientacion'], [], [['text', '/familia/orientacion']], [], [], []],
    'orientacion_reserva' => [['id'], ['_controller' => 'App\\Controller\\FamiliaController::reservaOrientacion'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/familia/orientacion']], [], [], []],
    'cita_consulta_orientacion' => [['username'], ['_controller' => 'App\\Controller\\FamiliaController::consultasOrientacion'], [], [['variable', '/', '[^/]++', 'username', true], ['text', '/consulta/orientacion']], [], [], []],
    'secretaria' => [[], ['_controller' => 'App\\Controller\\FamiliaController::indexSecretaria'], [], [['text', '/familia/secretaria']], [], [], []],
    'secretaria_reserva' => [['id'], ['_controller' => 'App\\Controller\\FamiliaController::reservaSecretaria'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/familia/secretaria']], [], [], []],
    'cita_consulta_secretaria' => [['username'], ['_controller' => 'App\\Controller\\FamiliaController::consultasSecretaria'], [], [['variable', '/', '[^/]++', 'username', true], ['text', '/consulta/secretaria']], [], [], []],
