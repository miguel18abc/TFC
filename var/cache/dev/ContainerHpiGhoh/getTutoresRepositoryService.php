 ...
 */
class getTutoresRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TutoresRepository' shared autowired service.
     *
     * @return \App\Repository\TutoresRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TutoresRepository.php';

        return $container->privates['App\\Repository\\TutoresRepository'] = new \App\Repository\TutoresRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
