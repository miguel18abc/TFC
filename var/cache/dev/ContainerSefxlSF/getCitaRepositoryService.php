 ...
 */
class getCitaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CitaRepository' shared autowired service.
     *
     * @return \App\Repository\CitaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CitaRepository.php';

        return $container->privates['App\\Repository\\CitaRepository'] = new \App\Repository\CitaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
