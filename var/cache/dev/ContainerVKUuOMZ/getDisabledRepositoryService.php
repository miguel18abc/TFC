 ...
 */
class getDisabledRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DisabledRepository' shared autowired service.
     *
     * @return \App\Repository\DisabledRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DisabledRepository.php';

        return $container->privates['App\\Repository\\DisabledRepository'] = new \App\Repository\DisabledRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
