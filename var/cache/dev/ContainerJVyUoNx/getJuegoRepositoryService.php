 ...
 */
class getJuegoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\JuegoRepository' shared autowired service.
     *
     * @return \App\Repository\JuegoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'JuegoRepository.php';

        return $container->privates['App\\Repository\\JuegoRepository'] = new \App\Repository\JuegoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
