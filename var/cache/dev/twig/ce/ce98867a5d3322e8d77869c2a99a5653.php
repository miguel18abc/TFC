...
class __TwigTemplate_ac85adf7963eea6ea5f4c1a7104cf813 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 51
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_calendar_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["calendar"]) || array_key_exists("calendar", $context) ? $context["calendar"] : (function () { throw new RuntimeError('Variable "calendar" does not exist.', 51, $this->source); })()), "id", [], "any", false, false, false, 51)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "calendar/show.html.twig", "C:\\Users\\migue\\Desktop\\TFC1\\templates\\calendar\\show.html.twig");
    }
}
