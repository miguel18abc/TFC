...
class __TwigTemplate_1e253a1c469dd656f4ead1d25f985598 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a class=\"btn btn-primary\" href=\"/familia/";
        // line 2
        echo twig_escape_filter($this->env, (isset($context["trabajador"]) || array_key_exists("trabajador", $context) ? $context["trabajador"] : (function () { throw new RuntimeError('Variable "trabajador" does not exist.', 2, $this->source); })()), "html", null, true);
        echo "/";
    ...
    <a class=\"btn btn-primary\" href=\"/familia/{{trabajador}}/{{servicio}}\">Volver a {{servicio}}</a> ", "familia/menu.html.twig", "C:\\Users\\migue\\Desktop\\TFC1\\templates\\familia\\menu.html.twig");
    }
}
