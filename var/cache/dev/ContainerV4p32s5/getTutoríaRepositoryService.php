 ...
 */
class getTutoríaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TutoríaRepository' shared autowired service.
     *
     * @return \App\Repository\TutoríaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TutoríaRepository.php';

        return $container->privates['App\\Repository\\TutoríaRepository'] = new \App\Repository\TutoríaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
